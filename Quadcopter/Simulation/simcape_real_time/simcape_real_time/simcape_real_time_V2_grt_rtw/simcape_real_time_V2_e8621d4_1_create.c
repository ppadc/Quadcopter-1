...
extern const NeAssertData simcape_real_time_V2_e8621d4_1_assertData[];
extern const NeZCData simcape_real_time_V2_e8621d4_1_ZCData[];
void simcape_real_time_V2_e8621d4_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void simcape_real_time_V2_e8621d4_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void simcape_real_time_V2_e8621d4_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void simcape_real_time_V2_e8621d4_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void simcape_real_time_V2_e8621d4_1_initializeGeometries(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId simcape_real_time_V2_e8621d4_1_compDerivs(
...
PmfMessageId simcape_real_time_V2_e8621d4_1_numJacPerturbLoBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_numJacPerturbHiBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_computeZeroCrossings(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId simcape_real_time_V2_e8621d4_1_recordLog(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
void simcape_real_time_V2_e8621d4_1_setTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  CTarget *targets);
...
void simcape_real_time_V2_e8621d4_1_resetSimStateVector(const void *mech, double
  *stateVector);
void simcape_real_time_V2_e8621d4_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *modeVector,
  const double *motionData,
  double *stateVector);
void simcape_real_time_V2_e8621d4_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void simcape_real_time_V2_e8621d4_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void simcape_real_time_V2_e8621d4_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void simcape_real_time_V2_e8621d4_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void simcape_real_time_V2_e8621d4_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void simcape_real_time_V2_e8621d4_1_computePosDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void simcape_real_time_V2_e8621d4_1_computeVelDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void simcape_real_time_V2_e8621d4_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void simcape_real_time_V2_e8621d4_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t simcape_real_time_V2_e8621d4_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t simcape_real_time_V2_e8621d4_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t simcape_real_time_V2_e8621d4_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
boolean_T simcape_real_time_V2_e8621d4_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
void simcape_real_time_V2_e8621d4_1_convertStateVector(
  const void *asmMech,
...
void simcape_real_time_V2_e8621d4_1_constructStateVector(
  const void *mech,
...
void simcape_real_time_V2_e8621d4_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
boolean_T simcape_real_time_V2_e8621d4_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
boolean_T simcape_real_time_V2_e8621d4_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId simcape_real_time_V2_e8621d4_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  double *stateVector,
  void *neDiagMgr);
void simcape_real_time_V2_e8621d4_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
...
void simcape_real_time_V2_e8621d4_1_resetModeVector(const void *mech, int
  *modeVector);
boolean_T simcape_real_time_V2_e8621d4_1_hasJointDisToNormModeChange(
  const void *mech,
...
PmfMessageId simcape_real_time_V2_e8621d4_1_performJointDisToNormModeChange(
  ...
  double *stateVector,
  void *neDiagMgr);
void simcape_real_time_V2_e8621d4_1_onModeChangedCutJoints(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector,
  double *stateVector);
PmfMessageId simcape_real_time_V2_e8621d4_1_assemble(const double *u, double
  *udot, double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  simcape_real_time_V2_e8621d4_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  simcape_real_time_V2_e8621d4_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  simcape_real_time_V2_e8621d4_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mSimRuntimeDerivedValuesBundle);
  simcape_real_time_V2_e8621d4_1_initializeGeometries
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  simcape_real_time_V2_e8621d4_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = simcape_real_time_V2_e8621d4_1_compDerivs(
      &smData->mSimRuntimeDerivedValuesBundle,
      ...
      systemInput->mM.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 10,
      systemInput->mV.mX + 10,
      systemInput->mD.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = simcape_real_time_V2_e8621d4_1_numJacPerturbLoBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = simcape_real_time_V2_e8621d4_1_numJacPerturbHiBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = simcape_real_time_V2_e8621d4_1_compOutputs(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = simcape_real_time_V2_e8621d4_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 10,
    systemInput->mV.mX + 10,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    simcape_real_time_V2_e8621d4_1_computeZeroCrossings(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 10,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  simcape_real_time_V2_e8621d4_1_constructStateVector(
    NULL,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 10,
    systemInput->mD.mX,
    fullStateVector);
  errorId = simcape_real_time_V2_e8621d4_1_recordLog(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    fullStateVector,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL) {
    double result = 0.0;
    errorId = simcape_real_time_V2_e8621d4_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 10,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = simcape_real_time_V2_e8621d4_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 10,
      systemInput->mV.mX + 10,
  ...
  simcape_real_time_V2_e8621d4_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const int32_T stateVectorMap[8] = {
    12, 13, 14, 15, 16, 17, 18, 19
  };

  const CTarget targets[32] = {
    { 0, 63, 0, false, 0, 0, "1", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 0, false, 0, 0, "1", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 1, false, 0, 0, "1", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 1, false, 0, 0, "1", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 2, false, 0, 0, "1", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 2, false, 0, 0, "1", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 3, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 3, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 4, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 4, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 5, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 5, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 77, 0, false, 0, 2, "deg", false, true, +1.000000000000000000e+00,
      false, 1, { +1.570796326794896558e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 77, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 78, 0, false, 0, 2, "deg", false, true, +1.000000000000000000e+00,
      false, 1, { +1.570796326794896558e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 78, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 79, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 79, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 80, 0, false, 0, 2, "deg", false, true, +1.000000000000000000e+00,
      false, 1, { +1.570796326794896558e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 80, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 1, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 1, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 2, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 2, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 3, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 3, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 4, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 4, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 5, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 63, 5, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } }
  };
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = simcape_real_time_V2_e8621d4_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = simcape_real_time_V2_e8621d4_1_ZCData;
    size_t i;
...
{
  const char *varFullPaths[8] = {
    "Revolute_Joint3.Rz.q",
    "Revolute_Joint3.Rz.w",
    "Revolute_Joint4.Rz.q",
    "Revolute_Joint4.Rz.w",
    "Revolute_Joint.Rz.q",
    "Revolute_Joint.Rz.w",
    "Revolute_Joint1.Rz.q",
    "Revolute_Joint1.Rz.w"
  };

  const char *varObjects[8] = {
    "simcape_real_time_V2/Revolute Joint3",
    "simcape_real_time_V2/Revolute Joint3",
    "simcape_real_time_V2/Revolute Joint4",
    "simcape_real_time_V2/Revolute Joint4",
    "simcape_real_time_V2/Revolute Joint",
    "simcape_real_time_V2/Revolute Joint",
    "simcape_real_time_V2/Revolute Joint1",
    "simcape_real_time_V2/Revolute Joint1"
  };
  ...
  void initIoInfo(NeDaePrivateData *smData)
{
  ...
  const SizePair inputDimensions[10] = {
    { 1, 1 }, { 1, 1 }, { 1, 1 }, { 1, 1 },
  ...
  initIoInfoHelper(10, inputPortPaths, inputUnits, inputDimensions,
                   true, smData);
...
{
  const int32_T numInputDerivs[10] = {
    2, 2, 2, 2, 2, 2, 0, 0, 0, 0
  };
...
{
  const boolean_T directFeedthroughVector[10] = {
    true, true, true, true, true, true, false, false, false, false
  };

  const boolean_T directFeedthroughMatrix[80] = {
...

  {
    const int_T status = pm_create_bool_vector_fields(
      &smData->mDirectFeedthroughVector, 10, alloc);
    checkMemAllocStatus(status);
  ...
  {
    const int_T status = pm_create_bool_vector_fields(
      &smData->mDirectFeedthroughMatrix, 80, alloc);
    checkMemAllocStatus(status);
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  const SmSizePair jointToStageIdx[5] = {
    { 63, 0 }, { 77, 3 }, { 78, 4 }, { 79, 1 }, { 80, 2 }
  };

  const size_t primitiveIndices[5 + 1] = {
    0, 6, 7, 8, 9, 10
  };
  ...
  sm_core_SmRealVector_create(&scratchpad->mMotionData, 65, 0.0);
  delegate->mSetTargets = simcape_real_time_V2_e8621d4_1_setTargets;
  delegate->mResetStateVector =
    simcape_real_time_V2_e8621d4_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    simcape_real_time_V2_e8621d4_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState =
    simcape_real_time_V2_e8621d4_1_computeDiscreteState;
  delegate->mAdjustPosition = simcape_real_time_V2_e8621d4_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    simcape_real_time_V2_e8621d4_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputePosDofBlendMatrix =
    simcape_real_time_V2_e8621d4_1_computePosDofBlendMatrix;
  delegate->mComputeVelDofBlendMatrix =
    simcape_real_time_V2_e8621d4_1_computeVelDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    simcape_real_time_V2_e8621d4_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = simcape_real_time_V2_e8621d4_1_propagateMotion;
  delegate->mComputeAssemblyError =
    simcape_real_time_V2_e8621d4_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    simcape_real_time_V2_e8621d4_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    simcape_real_time_V2_e8621d4_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    simcape_real_time_V2_e8621d4_1_isInKinematicSingularity;
  delegate->mConvertStateVector =
    simcape_real_time_V2_e8621d4_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector =
    simcape_real_time_V2_e8621d4_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    simcape_real_time_V2_e8621d4_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    simcape_real_time_V2_e8621d4_1_perturbFlexibleBodyState;
  ...
  delegate->mExtractSolverStateVector =
    simcape_real_time_V2_e8621d4_1_extractSolverStateVector;
  delegate->mIsPositionViolation =
    simcape_real_time_V2_e8621d4_1_isPositionViolation;
  delegate->mIsVelocityViolation =
    simcape_real_time_V2_e8621d4_1_isVelocityViolation;
  delegate->mProjectStateSim = simcape_real_time_V2_e8621d4_1_projectStateSim;
  delegate->mComputeConstraintError =
    simcape_real_time_V2_e8621d4_1_computeConstraintError;
  delegate->mResetModeVector = simcape_real_time_V2_e8621d4_1_resetModeVector;
  delegate->mHasJointDisToNormModeChange =
    simcape_real_time_V2_e8621d4_1_hasJointDisToNormModeChange;
  delegate->mPerformJointDisToNormModeChange =
    simcape_real_time_V2_e8621d4_1_performJointDisToNormModeChange;
  delegate->mOnModeChangedCutJoints =
    simcape_real_time_V2_e8621d4_1_onModeChangedCutJoints;
  delegate->mMech = NULL;
}
