...
const NeZCData *simcape_real_time_V2_e8621d4_1_ZCData = NULL;
PmfMessageId simcape_real_time_V2_e8621d4_1_computeAsmModeVector(const double
...
PmfMessageId simcape_real_time_V2_e8621d4_1_computeSimModeVector(const double
  *input, const double *inputDot, const double *inputDdot, int *modeVector,
  double *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId simcape_real_time_V2_e8621d4_1_computeZeroCrossings(const
