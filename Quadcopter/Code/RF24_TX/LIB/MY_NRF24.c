...
void NRF24_begin(GPIO_TypeDef *nrf24PORT, uint16_t nrfCSN_Pin, uint16_t nrfCE_Pin, SPI_HandleTypeDef nrfSPI)
{
	...
	NRF24_write_register(0x00, 0x02); //0x08
	NRF24_write_register(0x01, 0x00); //0x3f
	NRF24_write_register(0x02, 0x00); //0x03
	NRF24_write_register(0x03, 0x00); //0x03
	NRF24_write_register(0x04, 0x00); //0x03
	NRF24_write_register(0x05, 0x02); //0x02
	NRF24_write_register(0x06, 0x00); //0x0f
	NRF24_write_register(0x07, 0x00); //0x0e
