/**
 * @file td_rf24l01.h
 * @brief Header file for the NRF24L01+ radio module.
 *
 * This header file contains the function prototypes and definitions for the NRF24L01+ radio module.
 * The NRF24L01+ is a low-cost, ultra-low power, high-performance 2.4GHz ISM band wireless transceiver.
 * It is designed for use in applications that require low power consumption and low data rates.
 * The module is capable of operating in both point-to-point and point-to-multipoint configurations.
 * It is compatible with a wide range of microcontrollers and can be easily integrated into existing designs.
 *
 * @author Tan Dat
 * @date 2023-6
 */
#ifndef TD_RF24L01_H // Kiểm tra xem FILE_NAME_H đã được định nghĩa chưa
#define TD_RF24L01_H // Nếu chưa thì định nghĩa nó
/* Includes ------------------------------------------------------------------*/
#include "define.h"
#include <stdlib.h>
#include <stdbool.h>
